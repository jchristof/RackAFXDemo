...
*/
CRackAFXDemoPlugin::CRackAFXDemoPlugin()
{
	...
	m_PlugInName = "RackAFXDemoPlugin";
...
*/
CRackAFXDemoPlugin::~CRackAFXDemoPlugin(void)
{
...
*/
bool __stdcall CRackAFXDemoPlugin::initialize()
{
	// Add your code here
...
processRackAFXMessage()
	...
	See the website www.willpirkle.com for more details
*/
void __stdcall CRackAFXDemoPlugin::processRackAFXMessage(UINT uMessage, PROCESS_INFO& processInfo)
{
...
*/
bool __stdcall CRackAFXDemoPlugin::prepareForPlay()
{
	// Add your code here:
...
*/
bool __stdcall CRackAFXDemoPlugin::processAudioFrame(float* pInputBuffer, float* pOutputBuffer, UINT uNumInputChannels, UINT uNumOutputChannels)
{
	...
	// (INSERT Effect)
	const auto xn = pInputBuffer[0];
	const auto xn_1 = m_f_z1_left;
	const auto yn = m_f_a0_left * xn + m_f_a1_left * xn_1;
...
//
bool __stdcall CRackAFXDemoPlugin::userInterfaceChange(int nControlIndex)
{
...
bool __stdcall CRackAFXDemoPlugin::checkUpdateGUI(int nControlIndex, float fValue, CLinkedList<GUI_PARAMETER>& guiParameters, bool bLoadingPreset)
{
...
bool __stdcall CRackAFXDemoPlugin::processAuxInputBus(audioProcessData* pAudioProcessData)
{
...
*/
bool __stdcall CRackAFXDemoPlugin::joystickControlChange(float fControlA, float fControlB, float fControlC, float fControlD, float fACMix, float fBDMix)
{
	// add your code here
...
/* processAudioBuffer
	...
	******************************
	...
	m_HostProcessInfo.uTimeSigDenomintor = Host Time Signature Denominator (if supported by host)
*/
bool __stdcall CRackAFXDemoPlugin::processRackAFXAudioBuffer(float* pInputBuffer, float* pOutputBuffer,
...
*/
bool __stdcall CRackAFXDemoPlugin::processVSTAudioBuffer(float** inBuffer, float** outBuffer, UINT uNumChannels, int inFramesToProcess)
{
...
bool __stdcall CRackAFXDemoPlugin::midiNoteOn(UINT uChannel, UINT uMIDINote, UINT uVelocity)
{
	return true;
}

bool __stdcall CRackAFXDemoPlugin::midiNoteOff(UINT uChannel, UINT uMIDINote, UINT uVelocity, bool bAllNotesOff)
{
	return true;
}

// uModValue = 0->127
bool __stdcall CRackAFXDemoPlugin::midiModWheel(UINT uChannel, UINT uModValue)
{
	return true;
}
...
bool __stdcall CRackAFXDemoPlugin::midiPitchBend(UINT uChannel, int nActualPitchBendValue, float fNormalizedPitchBendValue)
{
	return true;
}
...
*/
bool __stdcall CRackAFXDemoPlugin::midiClock()
{
...
bool __stdcall CRackAFXDemoPlugin::midiMessage(unsigned char cChannel, unsigned char cStatus, unsigned char
...
*/
void CRackAFXDemoPlugin::doVSTSampleAccurateParamUpdates()
{
...
void* __stdcall CRackAFXDemoPlugin::showGUI(void* pInfo)
{
...
bool __stdcall CRackAFXDemoPlugin::initUI()
{
	// ADDED BY RACKAFX -- DO NOT EDIT THIS CODE!!! -------------------------------------- //
...
// **--0xDEA7--**
	...
	ui1->fUserDisplayDataHiLimit = 0.490000;
	...
	ui1->m_pUserCookedFloatData = &m_fSlider_a1;
	ui1->m_pUserCookedDoubleData = NULL;
	ui1->m_pUserCookedUINTData = NULL;
	ui1->cControlUnits = "";
	ui1->cVariableName = "m_fSlider_a1";
